...
Once running, any MCP-compatible client can call Orchestra's six composite tools.
...
Six biological validation cases confirm that Orchestra's routing, evidence coordination, and synthesis layers function correctly (Table 1).
